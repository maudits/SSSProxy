...
ascii = """
 ___ ___ ___ _ __  _ __ _____  ___   _ 
/ __/ __/ __| '_ \| '__/ _ \ \/ / | | |
\__ \__ \__ \ |_) | | | (_) >  <| |_| |
...
if '__main__' == __name__:
    reactor.listenTCP(listening_port,SOCKSv4Factory("./sssproxy.log"))
    print ascii
    print "* hex view: tail -f sssproxy.log"
    print "* listening on ",listening_port
    print "* have fun\n\n"
    reactor.run()
